...
namespace Modbus.IO
{
    ...
    public abstract class ModbusTransport : IDisposable
    {
            ...
            where T : IModbusMessage, new()
        {
            ...
            do
            {
                try
                {
                    ...
                    ValidateResponse(message, response, this is ModbusIpTransport);
                    success = true;
                }
        ...
        internal void ValidateResponse(IModbusMessage request, IModbusMessage response, bool validateSlaveAddress = true)
        {
            ...
            if (validateSlaveAddress && request.SlaveAddress != response.SlaveAddress)
            {
